...
import { SliderWithFourBlocksModule } from 'src/app/slider-with-four-blocks/slider-with-four-blocks.module';
import { SliderWithOneBlockCenterModule } from 'src/app/slider-with-one-block-center/slider-with-four-blocks.module';
import { SliderWithThreeCenterBlocksModule } from 'src/app/slider-with-three-center-blocks/slider-with-four-blocks.module';
...
import { WithArrowToBottomModule } from 'src/app/with-arrow-to-bottom/slider-with-four-blocks.module';
